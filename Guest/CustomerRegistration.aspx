		...
		<a href="#"><div class="reg_fb"><i>Specify Details</i><div class="clear"></div></div></a>
		 ...
		 <!-- Form -->
			<form id="registration_form" action="contact.php" method="post">
                ...
                Enter Company Id
					<label>
						<input placeholder="Customer Id:" type="text" tabindex="1" required="" autofocus="" runat="server" id="txtCustomerId"><asp:RegularExpressionValidator 
                        ID="RegularExpressionValidator1" runat="server" 
                        ControlToValidate="txtCustomerId" ErrorMessage="Invalid"></asp:RegularExpressionValidator>
&nbsp;</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                <div>
                Enter Password
					<label>
