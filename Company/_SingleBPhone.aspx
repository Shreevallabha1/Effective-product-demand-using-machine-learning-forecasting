...
<div class="login_left">
		<h3>BASIC PHONE DEMAND</h3>
		<div class="btn">
			<form>
				&nbsp;</form>
		  <p style="font-size: 16px;">Enter all parameters and click on the submit button to know the demand for the product for the inputted parameters...</p>
<p style="font-size: 16px;">
    <span class="style1" style="font-size: 18px;">fm(1-no,2-yes)</span>, <span class="style2" style="font-size: 18px;">
    battery(0-low,1-medium,2-high,3-veryhigh)</span>, <span class="style3" style="font-size: 18px;">
    color(0-white,1-black,2-grey,3-red,4-blue)</span>, <span class="style4" style="font-size: 18px;">
    camera(1-0.1MP,2-0.2MP,3-0.3MP,4-0.4MP,5-0.5MP,6-0.6MP,7-0.7MP,8-0.8MP)</span>,
    <span class="style5" style="font-size: 18px;">ram(1-4MB,2-8MB,3-16MB,4-24MB,5-32MB)</span>,
    <span class="style6" style="font-size: 18px;">storage(1-1GB,2-2GB,3-4GB,4-&lt;4GB)</span>,
    <span class="style7" style="font-size: 18px;">dualsim(1-single sim,2-dual sim)</span>
</p>
