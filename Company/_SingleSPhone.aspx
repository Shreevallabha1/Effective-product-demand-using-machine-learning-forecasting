...
<div class="login_left">
		<h3>SMART PHONE DEMAND</h3>
		<div class="btn">
			<form>
				&nbsp;</form>
		  
<p style="font-size: 18px;">Enter all parameters and click on the submit button to know the demand for the product for the inputted parameters...</p>
<p style="font-size: 18px;">
    <span class="style1" style="font-size: 20px;">os (1-windows,2-android,3-kitkat,4-blackberry)</span>,
    <span class="style3" style="font-size: 20px;">color(0-white,1-black,2-grey,3-red,4-blue)</span>,
    <span class="style4" style="font-size: 20px;">pcamera(1-5to10MP,2-11to20MP,3-&lt;20MP)</span>,
    <span class="style8" style="font-size: 20px;">scamera(1-5to10MP,2-11to20MP,3-&lt;20MP)</span>,
    <span class="style5" style="font-size: 20px;">ram(1-1GB,2-2GB,3-4GB,4-8GB,5-16GB)</span>,
    <span class="style6" style="font-size: 20px;">storage(1-0-16GB,2-17-64GB,3-&lt;65GB)</span>,
    <span class="style9" style="font-size: 20px;">speed(1->2GHz,2-<2GHz)</span>,
    <span class="style7" style="font-size: 20px;">dualsim(1-single sim,2-dual sim)</span>,
    <span class="style6" style="font-size: 20px;">display(1-&gt;5inch,2-&lt;5inch)</span>
</p>
		</div>
	</div>
